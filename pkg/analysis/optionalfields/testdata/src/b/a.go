...
type A struct {
	...
	// +optional
	IntWithInvalidMinimumValue int `json:"intWithInvalidMinimumValue,omitempty"` // want "field IntWithInvalidMinimumValue has an invalid minimum marker: error getting marker value: error converting value to integer: strconv.Atoi: parsing \\\"foo\\\": invalid syntax"

	// intWithInvalidMaximumValue with invalid maximum value is an int field.
	// +kubebuilder:validation:Maximum=foo
	// +optional
	IntWithInvalidMaximumValue int `json:"intWithInvalidMaximumValue,omitempty"` // want "field IntWithInvalidMaximumValue has an invalid maximum marker: error getting marker value: error converting value to integer: strconv.Atoi: parsing \\\"foo\\\": invalid syntax"
	...
	// +kubebuilder:validation:Minimum=foo
	// +optional
	FloatWithInvalidMinimumValue float64 `json:"floatWithInvalidMinimumValue,omitempty"` // want "field FloatWithInvalidMinimumValue has an invalid minimum marker: error getting marker value: error converting value to float: strconv.ParseFloat: parsing \\\"foo\\\": invalid syntax"

	// floatWithInvalidMaximumValue with invalid maximum value is a float field.
	// +kubebuilder:validation:Maximum=foo
	// +optional
	FloatWithInvalidMaximumValue float64 `json:"floatWithInvalidMaximumValue,omitempty"` // want "field FloatWithInvalidMaximumValue has an invalid maximum marker: error getting marker value: error converting value to float: strconv.ParseFloat: parsing \\\"foo\\\": invalid syntax"
